...
const STATIC_CONTENT: Record<string, { title: string; content: string; image?: string }> = {
  ...
  'geschiedenis': {
    ...
    content: `
      ...
      <p>De eerste avond after de bevrijding, waarop weer gemarcheerd werd, kwam Jurrie Weijs behouden terug uit Oostenrijk. Hij stond direct weer in de voorste gelederen als trommelslager.</p>
            ...
            <div className="max-w-3xl mx-auto">
               ...
               {(slug === 'steun-ons' || page.slug === 'steun-ons') && (
                 <div className="mt-20 pt-10 border-t border-gray-100">
                    <SponsorGrid variant="full" title="Zij dragen onze vereniging een warm hart toe" />
                 </div>
               )}
